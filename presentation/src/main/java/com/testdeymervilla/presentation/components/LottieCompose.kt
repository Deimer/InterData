...
import com.testdeymervilla.presentation.utils.PresentationConstants.AnimationConstants.SPEED_ANIMATION
import com.testdeymervilla.presentation.utils.PresentationConstants.AnimationConstants.SPEED_ANIMATION_SIMPLE
...
fun LottieCompose(
    ...
    iterations: Int = ITERATION_SIMPLE,
    speed: Float = SPEED_ANIMATION,
    ...
    LaunchedEffect(key1 = progress) {
        if (progress == SPEED_ANIMATION_SIMPLE) {
